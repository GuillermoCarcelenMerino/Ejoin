...
public class PasarelaPagoJava extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        precio = (Number)getIntent().getExtras().get("precio");
    ...
    // Muestra el mensaje de respuesta y devuelve un okey de subscribción al evento
    private void showMessage(Integer result){
        AlertDialog.Builder builder1 = new AlertDialog.Builder(this);
        if(result==1){
            builder1.setMessage("Autorizado");
